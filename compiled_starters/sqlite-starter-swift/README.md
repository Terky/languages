...
The entry point for your SQLite implementation is in `Source/swift-sqlite-challange/Main.swift`. Study and uncomment the relevant code, and
...
1. Run `./your_sqlite3.sh` to run your program, which is implemented in
   `Source/swift-sqlite-challange/Main.swift`.
